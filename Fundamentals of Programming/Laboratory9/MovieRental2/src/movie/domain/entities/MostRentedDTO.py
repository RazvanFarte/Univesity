...
class MostRentedBookDTO(object):
    ...
    def __init__(self, movieId, movieTitle, rentedTimes):
        '''
        Tells us how many times was rented book with bookId and bookTitle
        '''
        
        self.__bookId = movieId
        self.__bookTitle = movieTitle
    ...
    def __str__(self):
        return "Id: {0}, Book: {1}, Rented times: {2}".format(self.movieId,self.movieTitle,self.rentedTimes)
